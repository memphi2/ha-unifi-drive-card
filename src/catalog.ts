...
const aggregateDefinitions: EntityDefinition[] = [
  ...
  sensor("at_risk_disk_count", "diagnostics", "At-risk drives", "mdi:harddisk-alert", 33, true),
...
const poolDefinitions: EntityDefinition[] = [
  ...
  sensor("pool_at_risk_drive_count", "pools", "At-risk drives", "mdi:harddisk-alert", 108, false, "pool"),
