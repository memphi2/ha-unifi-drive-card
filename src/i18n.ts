...
const EN: Record<string, string> = {
  ...
  "editor.device_help": "Select the Home Assistant device. The anchor entity below is only a fallback.",
...
const DE: Record<string, string> = {
  ...
  "editor.device": "Gerät",
  "editor.device_help": "Wähle das Home-Assistant-Gerät aus. Die Anker-Entität darunter ist nur ein Fallback.",
